...
/* $Id: plexp.h 1.2 89/09/26 16:48:02 rwm Exp $ */
/************************************************************************/
...
typedef struct
{
	...
	UCHAR rpt_rptl;			/* Repeat string length */
} EXP_RPT;
